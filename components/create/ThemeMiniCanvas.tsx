...
function drawMiniParticle(
  ...
  switch (shape) {
    ...
    case 'bear': {
      ...
      const s = p.size;
      const bodyColor  = p.color;                   // red from palette
      const bellyColor = 'rgba(255,143,168,0.90)';  // rosy pink belly
      const darkColor  = 'rgba(26,0,8,0.95)';       // near-black for features
      const heartColor = '#ff2255';
